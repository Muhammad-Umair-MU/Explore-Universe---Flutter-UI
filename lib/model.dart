class Planets {
  late final int planetNumber;
  late final String planetName;
  late final String description;
  late final String image;
  late final List<String> planetImages;
